...
export const Payment = () => {
  return (
    <div>
      <h1>Fill The Payment Details</h1>
      <div className="row">
        <div className="col-75">
          <div className="container">
            <form action="/action_page.php">
              <div className="row">
                <div className="col-50">
                  ...
                  <input
                    ...
                    id="adr"
                    name="address"
                    placeholder="120 boranada, Jodhpur"
                  />
                  <label htmlFor="city">
              ...
              Shipping address same as billing<input type="checkbox"  name="sameadr" />
              </label>
